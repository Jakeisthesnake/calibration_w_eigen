...
set_target_properties(Ceres::ceres PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "glog::glog;gflags;\$<LINK_ONLY:Threads::Threads>;\$<LINK_ONLY:SuiteSparse::CHOLMOD>;\$<LINK_ONLY:SuiteSparse::SPQR>;/usr/lib/x86_64-linux-gnu/libopenblas.so;\$<LINK_ONLY:-lm>;\$<LINK_ONLY:-ldl>;Eigen3::Eigen"
)
